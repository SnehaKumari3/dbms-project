...
<div class="header">
	<div class="header-top">
		<div class="wrap">
			<div class="h-logo">
			<a href="index.php"><img src="images/watching-a-movie.png" alt="Logo Image Here"/></a>
		</div>
			  <div class="nav-wrap">
        ...
        <form action="process_search.php" id="reservation-form" method="post" onsubmit="myFunction()">
		       <fieldset>
		       	<div class="field" >
                                ...
                                <input type="text" placeholder="Enter A Movie Name" style="height:30px;width:300px;color:black;"  required id="search111" name="search">
